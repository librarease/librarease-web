  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-purple-500/10 rounded-full blur-3xl animate-pulse delay-2000" />
      </div>
      ...
      <header className="relative z-10 px-4 lg:px-6 h-16 flex items-center border-b border-white/10 backdrop-blur-sm">
        <Link className="flex items-center justify-center" href="/">
          ...
          <span className="ml-3 text-xl font-bold bg-gradient-to-r from-emerald-400 to-emerald-300 bg-clip-text text-transparent">
            LibraryConnect
          </span>
        </Link>
      ...
      <main className="relative z-10">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-white/20 text-white hover:bg-white/10 px-8 py-6 text-lg backdrop-blur-sm bg-transparent"
                asChild
              >
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { icon: Building2, label: 'Libraries Connected', value: '500+' },
              { icon: Users, label: 'Active Users', value: '50K+' },
              { icon: BookOpen, label: 'Books Managed', value: '2M+' },
            ].map((stat, index) => {
              const Icon = stat.icon
              return (
                <div key={index} className="text-center group">
                  <div className="relative inline-flex items-center justify-center w-16 h-16 mb-4 mx-auto">
                    <Icon className="h-8 w-8 text-emerald-400 relative z-10" />
                    <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/20 to-blue-500/20 rounded-full blur-lg group-hover:blur-xl transition-all duration-300" />
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              return (
                <div
                  key={index}
                  className={`relative p-8 rounded-2xl border border-white/10 backdrop-blur-sm bg-gradient-to-br ${feature.gradient} group hover:border-white/20 transition-all duration-300`}
                >
                  <div className="relative">
                    <div className="inline-flex items-center justify-center w-12 h-12 mb-6 relative">
                      <Icon className="h-6 w-6 text-emerald-400 relative z-10" />
                      <div className="absolute inset-0 bg-emerald-500/20 rounded-lg blur-md group-hover:blur-lg transition-all duration-300" />
                    </div>
        ...
        <section className="container mx-auto px-4 py-24">
          <div className="max-w-4xl mx-auto text-center">
            <div className="relative p-12 rounded-3xl border border-white/10 backdrop-blur-sm bg-gradient-to-br from-emerald-500/5 to-blue-500/5">
